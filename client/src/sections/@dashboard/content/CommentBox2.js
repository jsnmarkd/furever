...
export default function CommentBox2() {
  return (
    <>
      <div className="card">
        ...
        <div className="comments">
          ...
          <div className="comment-container">
            ...
            <p className="comment-content">
              I've been using this product for a few days now and I'm really impressed! The interface is intuitive and
              easy to use, and the features are exactly what I need to streamline my workflow.
            </p>
          </div>
        </div>
